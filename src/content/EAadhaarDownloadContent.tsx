              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="p-4 text-sm text-gray-600">string</td>
                    <td className="p-4 text-sm text-gray-600">OTP received on mobile</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-mono text-sm">captcha</td>
                    <td className="p-4 text-sm text-gray-600">string</td>
                    <td className="p-4 text-sm text-gray-600">Captcha verification code</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-gray-100">
                    <td className="p-4 font-mono text-sm">downloadUrl</td>
                    <td className="p-4 text-sm text-gray-600">string</td>
                    <td className="p-4 text-sm text-gray-600">Secure download URL</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="p-4 font-mono text-sm">expiresAt</td>
                    <td className="p-4 text-sm text-gray-600">string</td>
                    <td className="p-4 text-sm text-gray-600">URL expiration time</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-mono text-sm">fileSize</td>
                    <td className="p-4 text-sm text-gray-600">number</td>
                    <td className="p-4 text-sm text-gray-600">File size in bytes</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
{`curl --location --request POST 'https://api.example.com/v1/e-aadhaar-download' \\
  ...
  "captcha": "ABC123"
          ...
          <div className="bg-gray-900 text-white rounded-lg overflow-hidden">
            ...
            <div className="p-4 overflow-x-auto">
              <pre className="text-sm font-mono">
{`{
  "downloadUrl": "https://secure.example.com/download/abc123",
